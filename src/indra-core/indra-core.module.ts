...
@NgModule({
  declarations: [ PIPES_CADENAS, PIPES_NUMERICOS, IndraSizerComponent, MIS_VALIDADORES, ],
  exports: [ PIPES_CADENAS, PIPES_NUMERICOS, IndraSizerComponent, MIS_VALIDADORES ],
  imports: [
    CommonModule
  ],
})
